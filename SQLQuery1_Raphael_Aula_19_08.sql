...
Insert Into Hospedes Values ('159874256911', 'Maria dos Santos', 'Av. Epit�cio Pessoa, 21, Jo�o Pessoa', 'F', '1960-02-06');
Insert Into Hospedes Values ('547221658922', 'Jo�o Augusto Trindade', 'R. das Flores, 33, Recife', 'M', '1980-05-14');
Insert Into Hospedes Values ('522655488922', 'Ana Maria Pereira', 'R. Augusta, 51, S�o Paulo', 'F', '1972-08-09');
Insert Into Hospedes Values ('922411035844', 'Luiza Costa', 'Av. Epit�cio Pessoa, 297, Jo�o Pessoa', 'F', '1985-12-24');
Insert Into Hospedes Values ('241699512000', 'Francisco Chaves dos Santos', 'R. Aurora, 95, Macei�', 'M', '1955-09-06');
Insert Into Hospedes Values ('621000385221', 'Ant�nio Alves', 'R. Jos� Firmino, 33, Rio de Janeiro', 'M', '1980-05-09');
Insert Into Hospedes (cpf, nome, endereco, sexo) Values ('453982210087', 'Marieta Gon�alves', 'R. Luiz Paiva, 90, Curitiba', 'F');
...
Insert Into Hospedes (cpf, nome, endereco, sexo) Values ('452981110385', 'Ana Paula Abrantes', 'R. Amparadouro Pereira, 80, S�o Paulo', 'F');
Insert Into Hospedes (cpf, nome, endereco, sexo) Values ('651582954399', 'M�rio Augisto Tarantela', 'R. das Flores, 55, Recife', 'M');




Insert Into Quartos Values (220, 'Standard', 250.60);
Insert Into Quartos Values (230, 'Su�te Master', 700);
Insert Into Quartos Values (240, 'Luxo Superior', 520);
Insert Into Quartos Values (250, 'Su�te Presidencial', 950);
Insert Into Quartos Values (320, 'Standard', 250.60);
Insert Into Quartos Values (330, 'Luxo Superior', 520);
Insert Into Quartos Values (340, 'Su�te Master', 700);
...
Insert Into Servicos Values (3, 'Bab�', 330);
Insert Into Servicos Values (4, 'Caf� no Quarto', 64.50);
...
#Exibir os dados dos hóspedes que não informaram data de nascimento
SELECT dataNascimento FROM Hospedes
WHERE dataNascimento IS NULL;

#Exibir os dados dos hóspedes que informaram data de nascimento
...
#GROUP BY é usada para agrupar linhas que possuem valores iguais em colunas especificadas.
#Exibir a quantidade de homens e mulheres hóspedes.
